...
export default function Authenticated({ header, children }) {
    ...
    useEffect(() => {
        conversations.forEach(conversation => {
            ...
            window.Echo.private(channel).error(error => {
                console.error(error);
            }).listen("SocketMessage", e => {
                const message = e.message;

                emit("message.created", message); //If the conversation with the sender is not selected then show a notification
